...
public class punto8 {
	public static void main(String[] args) {
		...
		do {
			...
			case 3:
				...
				for (int i = lista.size() - 1; i >= 0; i--) {
					if (lista.get(i).getLibretaU() == numlib) {
						Alumno modAl = new Alumno(lista.get(i).getNombre(), lista.get(i).getApellido(),
								lista.get(i).getLibretaU(), nots);
						lista.set(i, modAl);
					}
				}
				break;
			case 4:
				for (Alumno a : lista) {
					System.out.println(" Nombre :" + a.getNombre() + " _ Apellido: " + a.getApellido()
							+ " _ Numero de Libreta: " + a.getLibretaU() + " _ Promedio: " + a.getPromedio()
							+ " _ Nota maxima :" + a.getMax());
				}
				break;
			case 5:
				for (Alumno a : lista) {
